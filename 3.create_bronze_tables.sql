...
USING json
OPTIONS (path 'abfss://bronze@databricksucadlsext.dfs.core.windows.net/drivers.json');
...
USING json
OPTIONS (path 'abfss://bronze@databricksucadlsext.dfs.core.windows.net/results.json');
